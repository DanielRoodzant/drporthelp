...
vignette: >
  %\VignetteIndexEntry{relational_databases}
...
flu_data <- utils::read.csv(here::here("inst/relational_databases/flu_data.csv"), skip = 11) %>%
  dplyr::as_tibble()
dengue_data <- utils::read.csv(here::here("inst/relational_databases/dengue_data.csv"), skip = 11) %>%
  dplyr::as_tibble()
...
utils::write.csv(flu_data, "inst/relational_databases/flu_data_tidy.csv")
utils::write.csv(dengue_data, "inst/relational_databases/dengue_data_tidy.csv")
utils::write.csv(gapminder, "inst/relational_databases/gapminder.csv")
readr::write_rds(flu_data, "inst/relational_databases/flu_data_tidy.rds")
readr::write_rds(dengue_data, "inst/relational_databases/dengue_data_tidy.rds")
readr::write_rds(gapminder, "inst/relational_databases/gapminder.rds")
...
![SQLshell](../inst/relational_databases/sql_shell.png){width=100%}
<br>
Using the console to get information from the data
![DBeaverexample](../inst/relational_databases/DBeaver_example.png){width=100%}
